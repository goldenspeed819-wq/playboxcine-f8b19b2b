...
const AdminLayout = () => {
  ...
  const menuGroups: MenuGroup[] = [
    {
      ...
      icon: Film,
      items: [
        { icon: Film, label: 'Filmes', href: '/admin/movies' },
        { icon: Plus, label: 'Adicionar Filme', href: '/admin/movies/add' },
        { icon: Tv, label: 'Séries', href: '/admin/series' },
  ...
  const NavItem = ({ item, collapsed = false }: { item: MenuItem; collapsed?: boolean }) => {
  ...
  return (
    <TooltipProvider>
      <div className="min-h-screen bg-background">
        ...
        <aside
          className={cn(
            'fixed top-0 left-0 bottom-0 bg-card border-r border-border z-40 transition-all duration-300 flex flex-col',
            sidebarWidth,
            'lg:translate-x-0',
        ...
        >
          ...
          <div className={cn(
              ...
              <>
                <Tooltip delayDuration={0}>
                  <TooltipTrigger asChild>
                    <Link
                      to="/"
                      className="flex items-center justify-center w-10 h-10 rounded-xl text-muted-foreground hover:bg-muted hover:text-foreground transition-all duration-200"
                    >
            ...
            <button
              ...
              className={cn(
                'hidden lg:flex items-center justify-center w-full py-2 rounded-xl text-muted-foreground hover:bg-muted hover:text-foreground transition-all duration-200 mt-2',
